<template>
  <div>
    <div class="container" v-for="(ave, index) in arrAvengers" :key="index" >
      <div v-if="ave.name === avenger">
        <h1>{{ ave.name }}</h1>
        <div class="grid">
          <img :src="ave.img" alt="">
          <div class="about">
              <p v-for="(about, index) in ave.aboutAvenger" :key="index">{{ about }}</p>
          </div>
        </div>
      </div>
    </div>
...
<script>
import imgHulk from "../assets/imgs/HULK.png"
import imgSpiderMan from "../assets/imgs/SPIDER-MAN.png";
import imgIronMan from "../assets/imgs/IRON-MAN.png";
import imgThor from "../assets/imgs/THOR.png";
import imgHawkeye from "../assets/imgs/HAWKEYE.png";
import imgBlackWidow from "../assets/imgs/BLACK-WIDOW.png";
import imgCapitainAmerica from "../assets/imgs/CAPTAIN-AMERICA.png";
export default {
  props: {
    avenger: {
      type: String,
